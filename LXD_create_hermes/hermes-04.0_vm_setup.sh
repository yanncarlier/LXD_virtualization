...
echo "============================================="
echo " Hermes Agent VM — SSH & Firewall Setup"
echo "============================================="
...
echo "[3/4] Configuring UFW to allow only IPv4 SSH on port 22 and the Hermes Agent UI on 3100..."
...
echo "  ssh hermes@<VM_IP>"
echo "  (Password:hermes)"
echo ""
...
echo ""
echo "Hermes Agent UI: http://127.0.0.1:3100/"
echo ""
